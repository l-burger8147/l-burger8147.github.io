...
window.onload = console.log("CLUE 3: On the inspector/elements tab, expand the <head> section, then expand the <style> section then double click inside that text. The next clue is near the bottom where it says 'secret-hidden'")